...
namespace NovaFashion.CustomerSite.Services
{
    public class ProductApiClient(HttpClient httpClient)
    {
        ...
        public async Task<HttpResponseMessage> GetProductsAsync(int page, int pageSize, string sort, string filterStatus, string? search, decimal? minPrice = null, decimal? maxPrice = null, Guid? categoryId = null)
        {

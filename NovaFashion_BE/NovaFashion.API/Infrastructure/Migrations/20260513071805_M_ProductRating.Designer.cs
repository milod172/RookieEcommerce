...
namespace NovaFashion.API.Migrations
{
    ...
    [Migration("20260513071805_M_ProductRating")]
    partial class M_ProductRating
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NovaFashion.API.Entities.ProductImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NovaFashion.API.Entities.ProductRating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NovaFashion.API.Entities.UserRefreshToken", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("NovaFashion.API.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NovaFashion.API.Entities.Product", b =>
                {
                    b.HasOne("NovaFashion.API.Entities.Category", "Category")
                        .WithMany("Products")
